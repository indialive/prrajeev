/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b4cc91bbc5db2dbea063fec956373e3f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORDPRESS_API_URL">> {}
}
